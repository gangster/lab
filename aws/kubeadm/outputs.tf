...
output "controlplane_instance_id" {
  description = "The instance id of the control plane instance."
...
output "worker1_instance" {
  description = "The instance id of the first worker instance."
  value       = module.worker1_instance.id
}

output "worker2_public_ip" {
  description = "The public IP of the second worker instance."
  value       = module.worker2_instance.public_ip
}

output "worker2_instance_id" {
  description = "The instance id of the second worker instance."
